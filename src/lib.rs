...
impl Settings {
    pub fn get_pause_on_file_select(&self) -> bool {
        self.pause_on_file_select
    }
        ...
        process
            .until_closes(async {
                ...
                loop {
                    ...
                    load_removal(&settings, &mut state, &env);
...
fn load_removal(settings: &Settings, state: &mut AutoSplitterState, e: &Env) {
